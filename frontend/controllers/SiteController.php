...
class SiteController extends Controller
{
    ...
    //  pemanggilan pada tampilan home
    public function actionIndex()
    {
        $modelVisi = Visi::find()->all();
        $modelMisi = Misi::find()->all();
        $modelStruktur = Struktur::find()->all();
        $modelGambar = Gambar::find()->all();
